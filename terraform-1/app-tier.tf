    ...
    Statement = [
      {
        ...
        Resource = [
          "arn:aws:dynamodb:${var.aws_region}:*:table/${var.auth_users_table}",
          "arn:aws:dynamodb:${var.aws_region}:*:table/${var.auth_users_table}/index/*",
          "arn:aws:dynamodb:${var.aws_region}:*:table/${var.parking_slots_table}",
          "arn:aws:dynamodb:${var.aws_region}:*:table/${var.parking_slots_table}/index/*",
          "arn:aws:dynamodb:${var.aws_region}:*:table/${var.booking_table}",
          "arn:aws:dynamodb:${var.aws_region}:*:table/${var.booking_table}/index/*",
          "arn:aws:dynamodb:${var.aws_region}:*:table/${var.payment_table}",
          "arn:aws:dynamodb:${var.aws_region}:*:table/${var.payment_table}/index/*",
          "arn:aws:dynamodb:${var.aws_region}:*:table/${var.notification_table}",
          "arn:aws:dynamodb:${var.aws_region}:*:table/${var.notification_table}/index/*"
        ]
      }
    ]
  })
