...
locals {
  create_sqs_subscription = var.enable_sqs_subscription && var.notification_queue_url != "" && var.notification_queue_arn != "" && length(regexall("\\*", var.notification_queue_arn)) == 0
  booking_topic_arns = [
